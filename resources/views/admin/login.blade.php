...
@media screen and (max-width: 250px) {
    ...
    <body>
        <div class="main">
            <form class="main__form" id="login_form" method="post" >     
    @csrf
                <div class="main__form__inputs">
                    <h3>LOGIN</h3>
                    <div>
                        <input type="email" placeholder="  EMAIL" class="email" name="email" required id="input1">
                        <span id="span1"></span>
                    </div>
                    <div>
                        <input type="password" placeholder="  PASSWORD"  name="password" id="input2">
